...
from Sampling.bitwise_sampler.laplace_sampler_odo import *
#from Sampling.bitwise_sampler.laplace_sampler_ostack import *
from Sampling.bitwise_sampler.gaussian_sampler_ostack import *
from Sampling.bitwise_sampler.gaussian_sampler_odo import *
#from Sampling.bitwise_sampler.AND_gate_counter import *
#from Sampling.bitwise_sampler.test_ostack import *
from Sampling.DNG.dng_dlap import dlap_generator
from Sampling.DNG.dng_gauss import dgauss_generator
...
def bitwise_sample(mechanism='lap', n=4096, s=1, epsilon=1, delta=1e-5, lambd=128, num_party=3, ostack=0, approximation=0, r=(1, 1, 1, 1), binary=0, odo=1): 
...
def distributed_sample(mechanism='lap', n=4096, s=1, epsilon=0.1, delta=1e-5, lambd=128, num_party=3, compile_partial=1, check=0, binary=0, simulate=0):
